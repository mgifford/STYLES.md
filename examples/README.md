...
from the [templates](../templates/) folder to build your own.
...
| | Templates | Examples |
| :--- | :--- | :--- |
| **Purpose** | Blank starting point | Completed reference |
| **Content** | `[PLACEHOLDER]` values | Real, filled-in values |
| **Use** | Copy and customize | Read and compare |
